...
start "Snake 1 - Heuristic" cmd /k "set PORT=8000 && python main/heuristic_agent.py"

:: Start Snake 2 on port 8001
echo Starting MCTS Agent 3 on Port 8001...
start "Snake 2 - MCTS Final" cmd /k "set PORT=8001 && python main/mcts_agent-final.py"

:: Start Snake 3 on port 8002
echo Starting RL Agent on Port 8002...
start "Snake 3 - nagin" cmd /k "set PORT=8002 && python main/mcts_agent-variation.py"

:: Start Snake 4 on port 8003
echo Starting Vanilla MCTS on Port 8003...
start "Snake 4 - Vanilla MCTS" cmd /k "set PORT=8003 && python main/vanilla_mcts.py"
...
start "Battlesnake Game" cmd /k "python main/run_game.py"
